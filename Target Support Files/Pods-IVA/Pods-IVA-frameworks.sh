...
if [[ "$CONFIGURATION" == "IVAMock Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
  install_framework "${PODS_ROOT}/BonMot/BonMot.framework"
  install_dsym "${PODS_ROOT}/BonMot/BonMot.framework.dSYM"
  install_framework "${PODS_ROOT}/CryptoSwift/CryptoSwift.framework"
  install_dsym "${PODS_ROOT}/CryptoSwift/CryptoSwift.framework.dSYM"
  install_framework "${PODS_ROOT}/Nuke/Nuke.framework"
  install_dsym "${PODS_ROOT}/Nuke/Nuke.framework.dSYM"
  ...
  install_framework "${PODS_ROOT}/XCDYouTubeKit/XCDYouTubeKit.framework"
  install_dsym "${PODS_ROOT}/XCDYouTubeKit/XCDYouTubeKit.framework.dSYM"
  install_framework "${PODS_ROOT}/Yams/Yams.framework"
  install_dsym "${PODS_ROOT}/Yams/Yams.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVADev Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAUat Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAProd Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaDev Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaMock Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaUat Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaProd Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaAppStore Dev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaUat" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaProd" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaAppStore" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaDev" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
...
if [[ "$CONFIGURATION" == "IVAHaspaMock" ]]; then
  install_framework "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework"
  install_dsym "${PODS_ROOT}/ActionSheetPicker-3.0/ActionSheetPicker_3_0.framework.dSYM"
  install_framework "${PODS_ROOT}/Alamofire/Alamofire.framework"
  install_dsym "${PODS_ROOT}/Alamofire/Alamofire.framework.dSYM"
